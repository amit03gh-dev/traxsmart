...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <section className="top-space-margin bg-gradient-very-light-gray pt-20px pb-20px ps-45px pe-45px sm-ps-15px sm-pe-15px mt-3">
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-5 product-info">
              ...
              <p className="w-100 xl-w-100 mx-auto text-dark-gray">
                The TSindia140 GPS Device is a rugged, AIS140 &
                BIS16833-certified tracker designed for all vehicle types. With
                IP65 protection, a 1000mAh backup battery, fast 30-second GPS
                cold start, and support for SOS panic button, driver behavior
                monitoring, and fuel/temperature/load sensors, it offers
                reliable performance and complete fleet control in any
                environment.
              </p>
                ...
                <div className="tab-pane fade in active show" id="tab_five1">
                  <div className="row align-items-center justify-content-center">
                    <div className="col-lg-6 md-mb-40px">
                      <div className="d-flex align-items-center mb-5px">
                        <div className="col alt-font fw-500 text-base-color">
                          Unrivaled Reliability, Ultimate Control. Track
                          Smarter, Drive Safer.
                        </div>
                      </div>
                      ...
                      <p className="w-90">
                        ...
                        control, regulatory compliance, and real-time
                        visibility. Designed for vehicles of all kinds — from
                        commercial fleets to heavy-duty machines — it delivers
                        advanced features, remote management, and data-driven
                        insights to maximize operational efficiency.
                      </p>
                      <div>
                    ...
                    <div className="col-lg-6 col-md-6 position-relative z-index-1 md-mb-40px">
                      <div
                        className="atropos atropos-rotate-touch"
                        data-atropos=""
                      >
                        <div
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              ...
                              style={{
                                transform:
                                  "translate3d(0px, 0px, -50px) scale(1)",
                                transitionDuration: "300ms",
                              }}
                            ></span>
                          </div>
                    ...
                    <div className="col-12">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          ...
                          acceleration, Ignition ON/OFF, Tow detection, Power
                          cut, GPS signal lost, Emergency alert, Geofence
                          entry/exit, Device health check
                        </div>
                      </div>
                      ...
                      <div className="row bg-very-light-gray">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          Live location updates, 30s cold start, geo-fencing
                          enabled
                        </div>
                      </div>
                      <div className="row">
                      ...
                      <div className="row bg-very-light-gray">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          Fuel, door, AC, temperature, load sensors supported
                          via I/Os
                        </div>
                      </div>
                      <div className="row">
                  ...
                  <div className="row m-0">
                    <div className="col-12">
                      ...
                      <div className="row bg-very-light-gray">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          Acquisition: -147 dBm, Tracking: -163 dBm,
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          Reverse Polarity, Overvoltage, Short Circuit, Surge,
                          Load Dump
                        </div>
                      </div>
                      <div className="row bg-very-light-gray">
                      ...
                      <div className="row bg-very-light-gray">
                        ...
                        <div className="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">
                          FOTA, Odometer, Turn Detection, GPS Drift Control,
                          Driving Behavior
                        </div>
                      </div>
                      <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="col-12 col-md-4 last-paragraph-no-margin">
                      ...
                      <p className="w-80 md-w-100">
                        ...
                        system integrators, OEMs, and government projects.
                        Special pricing, custom branding, and integration
                        support available for orders of 50 units or more. Reach
                        out to our sales team for volume discounts and tailored
                        logistics.
                      </p>
                    </div>
                      ...
                      <div className="col-auto mt-60px pt-15px pb-15px ps-40px pe-40px md-ps-25px md-pe-25px bg-solitude-blue border-radius-100px">
                        <div className="feature-box feature-box-left-icon-middle">
                          ...
                          <div className="feature-box-content text-dark-gray fs-18">
                            For custom labeling, pre-configuration, or
                            white-label requests, contact our enterprise sales
                            desk.{" "}
                            <a
                              target="blank"
