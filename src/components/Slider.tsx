            ...
            {(img.title || img.subTitle || img.buttonText) && (
              ...
              >
                <div className={img.textColor || 'text-white'}>
                  {img.subTitle && (
                    <Text className="text-uppercase fw-bold small mb-2">{img.subTitle}</Text>
                  )}
                  {img.title && (
                    ...
                    <div className="d-inline-block mt-45px sm-mt-30px">
                      ...
                      >
                        <span>
                          ...
                          <span className="btn-double-text ls-minus-05px" data-text="Discover more">{img.buttonText}</span>
                        </span>
                      </a>
